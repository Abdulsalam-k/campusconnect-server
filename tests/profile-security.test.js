...
test("Reject profile update without authentication", async () => {
...
test("Register profile test user", async () => {
  const response = await fetch(
...
test("Login profile test user", async () => {
  const response = await fetch(
...
test("Authenticated user can update their profile", async () => {
  const response = await fetch(
    `${BASE_URL}/api/auth/profile`,
    {
      method: "PUT",
...
test("Profile update cannot change protected role", async () => {
  const response = await fetch(
    `${BASE_URL}/api/auth/profile`,
    {
      method: "PUT",
...
test("Profile update rejects missing name", async () => {
  const response = await fetch(
    `${BASE_URL}/api/auth/profile`,
    {
      method: "PUT",
...
test("Profile update rejects invalid image content", async () => {
